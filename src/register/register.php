...
<head>
  ...
  <!-- Title -->
  <title>The Notice Board | Sign Up to Get Started</title>
        ...
        <form class="mt-8 space-y-6" action="signup.php" method="POST">
          <div class="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <input id="username" name="username" type="text" autocomplete="username" required class="
                      appearance-none
                      rounded-none
                      relative
                      block
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <input id="terms" name="terms" type="checkbox" class="
                      ...
                      rounded
                    " />
              <label for="terms" class="ml-2  text-lg text-white">
          ...
          <!-- sign up -->
          <div class="mt-8">
            <button type="submit" name="signup_btn" class=" group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm rounded-md font-bold text-slate-900 bg-amber-300 hover:bg-amber-500 transition-colors duration-300 ">
